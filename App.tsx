      ...
      <SignedOut>
        <div className="flex flex-col items-center justify-center min-h-screen relative z-10">
          <div className="text-center space-y-8 animate-in fade-in zoom-in duration-700">
            <h1 className="text-6xl md:text-8xl font-bold tracking-tighter playfair text-stone-900">axiom</h1>
            <p className="text-xl serif italic text-stone-600 font-light">
              Your intelligent canvas for knowledge exploration.
            </p>
            <div className="pt-8">
              <SignInButton mode="modal">
                <button className="px-8 py-4 bg-stone-900 text-stone-100 rounded-full hover:bg-stone-800 transition-all hover:scale-105 shadow-lg uppercase tracking-[0.2em] text-xs font-medium">
                  Sign In to Begin
                </button>
              </SignInButton>
            </div>
      ...
      <SignedIn>
        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 px-12 py-8 flex justify-between items-center pointer-events-none transition-opacity duration-500 ${
          ...
          <div className="flex items-center space-x-6 pointer-events-auto">
            ...
            {canvasMode && (
              <div className="animate-in fade-in slide-in-from-right-2 duration-500 hidden md:block">
                <button 
                  onClick={reset}
